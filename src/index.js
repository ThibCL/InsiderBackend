    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                game1 = new Game_1.Game();
                game1.user = user;
                connection.getRepository(Game_1.Game).save(game1);
                game2 = new Game_1.Game();
                game2.user = user;
                connection.getRepository(Game_1.Game).save(game2);
